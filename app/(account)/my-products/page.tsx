...
export default function UserProductsPage() {
  ...
  const animateProgressBar = (duration: number, targetPercentage: number): void => {
  ...
  const moduleInformation: { href: string; title: string; status: string; icon: IconDefinition; color: string }[] = [
    {
      href: "/module/1",
  ...
  const intakeSteps: { name: string; status: string; icon: string; link: string }[] = [
    {
      name: "Intake Form",
      status: "Complete",
      icon: "faFilePen",
  ...
  const personalStatementConditions: { name: string; link: string }[] = [
  ...
  const customPersonalStatementConditions: { name: string; link: string }[] = [
    {
  ...
  const customNexusLetters: { name: string; link: string }[] = [
    {
      name: "Post-Traumatic Stress Disorder (PTSD)",
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10">
      ...
      <div className="flex items-center w-full sm:w-11/12 xl:w-8/12 p-10">
        ...
        />
        <h2 className="text-4xl font-bold text-amber-500"> Package</h2>
      </div>
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="all-modules">
            ...
            <AccordionContent>
              ...
              This universal resource is designed to empower all Grandmaster package holders with essential knowledge and tools. 
            ...
            <AccordionTrigger>
              <div className="flex w-full justify-between">
                <div className="flex items-center">
                  ...
                  <span className="text-lg">VetVictory Claim Guide</span>
                </div>
              </div>
            </AccordionTrigger>
            <AccordionContent>
              <div className="flex justify-start items-center w-full h-96 bg-[#0b1739] relative">
                ...
                <div className="flex flex-col items- w-8/12">
                  <p className="text-lg text-white mt-4 px-6 py-2 w-full self-start p-5">
                    Benefit from a comprehensive VetVictory Claim Guide, offering
