...
const SocialLinks = () => {
  return (
    <div className="flex flex-wrap justify-evenly gap-4 py-24">
      <a
        href="https://www.youtube.com"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-block text-red-600 font-bold py-2 px-4 rounded-lg text-5xl hover:bg-red-100 transition-colors "
      >
        
        <div className="flex items-center justify-center">
            <svg width="146px" height="103px" viewBox="0 0 256 180" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                <defs>
            ...
            <h1 className="text-3xl sm:text-4xl tracking-wide font-bold ml-5 ">Subscribe <br/> on Youtube</h1>
        </div>
      </a>
      <a
      ...
      >
        <Image src="/imgs/like-us-on-facebook-seeklogo.png" alt="Facebook" width={400} height={119}/>
      </a>
    </div>
  );
};
