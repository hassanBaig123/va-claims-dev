import {
  ...
  export function FAQLong() {
    const faqItems = [
        {
          id: "faq-item-1",
          question: "What makes the ClearPath Research Report so valuable?",
          answer: "The ClearPath Research Report is a comprehensive, personalized guide that provides you with a clear roadmap for your VA claim. It includes in-depth research, scientific evidence, winning strategies from similar cases, and a step-by-step action plan tailored to your unique situation."
        },
        {
          id: "faq-item-2",
