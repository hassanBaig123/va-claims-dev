...
const WhatWeDontDo = () => {
  return (
    <div
      id="whatwedontdo"
      className="w-full flex flex-col justify-center items-center text-center relative sm:pt-4 pt-4 pb-20 sm:pb-40 -mt-6 sm:-mt-32 mb-12 sm:mb-24"
      style={{
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mt-8 sm:mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {[
            ...
            <div key={index} className="flex flex-col items-center bg-white p-6 sm:p-8 rounded-lg shadow-custom">
              ...
              <p className="text-lg sm:text-lg text-gray-600 font-lexendDeca">{item.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mt-8 sm:mt-16 p-6 sm:p-8 bg-white rounded-lg shadow-custom">
          ...
          <p className="text-sm sm:text-base text-gray-600 font-lexendDeca">
