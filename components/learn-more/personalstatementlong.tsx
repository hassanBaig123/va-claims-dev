  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center relative mb-20 z-20 text-2xl text-white">
        <p className="w-full lg:w-1/2 p-6">Don't settle for a blanket approach to your VA claim. Get access to <span className="text-navyYellow">Gold Advantage</span> today and unlock the power of personalized personal statement templates – your voice, their language, your peace of mind.</p>
      </div>
